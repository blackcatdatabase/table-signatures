...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 2 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 3 · Changelog: fresh (18 d)</div>
</div>
...
- Pkg folder: [packages\signatures](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\signatures)
...
graph LR
  ...
  signatures["signatures"]:::center
  signatures -->|FK| crypto_algorithms["crypto_algorithms"]:::link
  signatures -->|FK| signing_keys["signing_keys"]:::accent
...
- Outbound (depends on): "crypto_algorithms", "signing_keys"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package signatures -Apply
