...
namespace BlackCat\Database\Packages\Signatures;
...
use BlackCat\Database\Packages\Signatures\Repository\SignatureRepository as GeneratedRepository;
...
{
  private SignatureRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof SignatureRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected SignatureRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\Signatures\Dto\SignatureDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\Signatures\Dto\SignatureDto|null { return $this->repo->getById($id, $asDto); }
