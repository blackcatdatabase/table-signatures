...
namespace BlackCat\Database\Packages\Signatures\Mapper;

use BlackCat\Database\Packages\Signatures\Dto\SignatureDto;
use BlackCat\Database\Packages\Signatures\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO SignatureDto:
 ...
 */
final class SignatureDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'subject_table' => 'subjectTable', 'subject_pk' => 'subjectPk', 'context' => 'context', 'algo_id' => 'algoId', 'signing_key_id' => 'signingKeyId', 'signature' => 'signature', 'payload_hash' => 'payloadHash', 'hash_algo_id' => 'hashAlgoId', 'created_at' => 'createdAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'algo_id', 'signing_key_id', 'hash_algo_id' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const BIN_COLS    = [ 'signature', 'payload_hash' ];
     ...
     * @return SignatureDto
     */
    public static function fromRow(array $row): SignatureDto
    {
        /** @var SignatureDto */
    ...
    public static function fromRowOrNull(?array $row): ?SignatureDto
    {
     ...
     *
     * @param SignatureDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(SignatureDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(SignatureDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(SignatureDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,SignatureDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,SignatureDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(SignatureDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,SignatureDto>
     */
