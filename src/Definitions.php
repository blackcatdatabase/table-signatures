...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'signatures'; }
    public static function contractView(): string { return 'vw_signatures'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'subject_table', 'subject_pk', 'context', 'algo_id', 'signing_key_id', 'signature', 'payload_hash', 'hash_algo_id', 'created_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'subject_table', 'subject_pk', 'context', 'algo_id' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'algo_id', 'signing_key_id', 'hash_algo_id' ]; }
