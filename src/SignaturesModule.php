...
final class SignaturesModule implements ModuleInterface
{
    public function name(): string { return 'table-signatures'; }
    public function table(): string { return 'signatures'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-crypto_algorithms', 'table-signing_keys' ]; }
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_sigs_subject' ],
            'foreignKeys' => [ 'fk_sigs_algo', 'fk_sigs_hash', 'fk_sigs_skey' ],
        ];
    }
}
